                ...
                <div class="site-content-in" style="height: 100%;">
                    ...
                    <div class="login login-v2">
                        ...
                        <div class="login-content">
                            <p class="login-content__redirect">Not registered yet?<a
                                    href="{{ route('register') }}">Registration</a></p>
                            ...
                            <form action="{{ route('login') }}" method="POST" class="form-with-label">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-green-light btn-block" type="submit">Log In</button>
                                </div>
                                ...
                                <div class="form-group social-container">
                                    <p class="social-container__title">Or log in with</p>
