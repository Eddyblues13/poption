...
<head>
    <meta charset="UTF-8">
    <title>The platform to learn online trading in financial markets | Pocket Option</title>
    <meta name="title" content="The platform to learn online trading in financial markets | Pocket Option" />
    ...
    <meta property="og:url" content="https://m.pocketoption.com/en/" />
    <meta property="og:title" content="The platform to learn online trading in financial markets" />
    <meta property="og:type" content="website" />
    <meta property="og:description"
        content="Welcome to the most contemporary and refined Platform for trading on financial markets. Create your free account and start using all the available trading opportunities and features to earn on trading." />
    <meta property="og:image" content="themes/cabinet/images/og-logo.png" />
    <meta property="og:image:secure_url" content="themes/cabinet/images/og-logo.png" />

    <meta property="fb:app_id" content="1766114290081567" />


    <link rel="stylesheet" href="themes/2017-09/css/main.css?v=1734687251">
    ...
    <script>
        window.dataLayer = window.dataLayer || [];
                window.dataLayer.push({"platform":2});
    ...
    <script>
        function onAppsFlyerLoad() {
            var oneLinkURL = "https://potrade.onelink.me/oyit";
            ...
            if (result && result.clickURL) {
                var eles = document.querySelectorAll('.js-android-link');
...
<body class="mobile new-year new-year--2024 home en-lang">

    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KBDR983M" height="0" width="0"
                        ...
                        <div class="mobile-block__lang">
                            <div class="languages js-languages">
                                <div class="languages__title">
                                    <svg class="svg-icon language-icon" width="25" height="25" viewBox="0 0 25 25"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#a7038)">
                                            <path
                                        ...
                                        <defs>
                                            <clipPath id="a7038">
                                                <path fill="currentColor" transform="translate(.5 .919)"
                                                    d="M0 0h24v24H0z" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                            ...
                            <div class="mb-block__in">
                                ...
                                <ul>
                                    <li><a class="mb-block__link"
                                            href="https://m.pocketoption.com/en/assets-current/">100+ trading
                                            instruments</a></li>
                                    <li><a class="mb-block__link"
                    ...
                    <div class="mobile-nav__col mobile-nav__col_3">
                        <div class="mb-block">
                            <div class="mb-block__in mb-block__in_transparent mb-block__btn-wrap">
                                <a href="{{route('register')}}" class="btn btn_blue btn_small-side-padding">
                                    Registration </a>
                                <a href="{{route('login')}}" class="btn btn_white btn_small-side-padding">
                                    Log In </a>
                            </div>
                        </div>
                        <div class="mb-block">
                                ...
                                <ul>
                                    <li>
                                        <a class="mb-block__link mb-block__link_web js-android-link1"
                                            href="https://apps.apple.com/gb/app/p%C3%B6cke%E1%B9%AB-%CF%8C%CF%81ti%E1%BB%8D%C5%8B-moneytracker/id6738608368"
                                            data-name="svg-link" target="_blank"
                                            data-layout='{"event":"gtm_events","ga4_event_name":"go_to_store_from_menu","store_name":"ios"}'>
                                            <svg class="svg-icon ios" viewBox="0 0 64 64" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M52.5255 23.3818C50.7553 24.4656 49.2891 25.9807 48.264 27.7854C47.2389 29.5901 46.6884 31.6254 46.6641 33.7008C46.6711 36.0367 47.3631 38.3192 48.6545 40.2656C49.9459 42.212 51.7799 43.7369 53.9293 44.6513C53.0819 47.3856 51.8277 49.9767 50.2089 52.3376C47.8925 55.6721 45.4706 59.0062 41.7854 59.0062C38.1003 59.0062 37.1525 56.8652 32.9056 56.8652C28.764 56.8652 27.2898 59.0765 23.9204 59.0765C20.5509 59.0765 18.1996 55.9878 15.4969 52.1973C11.9269 46.8872 9.96483 40.6598 9.84619 34.2622C9.84619 23.7329 16.6904 18.1525 23.429 18.1525C27.0091 18.1525 29.9925 20.5038 32.2388 20.5038C34.3798 20.5038 37.7142 18.0118 41.7854 18.0118C43.8787 17.9578 45.9531 18.4193 47.826 19.3557C49.6989 20.2922 51.3127 21.6748 52.5255 23.3818ZM39.8552 13.5545C41.6498 11.4433 42.6657 8.7803 42.7332 6.01022C42.7362 5.64505 42.7009 5.28056 42.6279 4.92276C39.5451 5.2239 36.6944 6.6932 34.6605 9.0293C32.8485 11.0564 31.7943 13.6483 31.6771 16.3646C31.6784 16.6949 31.7137 17.0243 31.7824 17.3474C32.0254 17.3933 32.2722 17.4169 32.5195 17.4177C33.9403 17.3047 35.3232 16.9039 36.5843 16.2398C37.8453 15.5757 38.9582 14.6621 39.8552 13.5545Z"
                                                    fill="currentColor" />
                                            </svg>
                                            IOS </a>
                                    </li>
                                    <li>
                                        <a class="mb-block__link mb-block__link_web js-android-link1"
                                            ...
                                            <svg class="svg-icon android" viewBox="0 0 64 64" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    ...
                                                    fill="currentColor" class="android__layer-1" />
                                                <path
                                                    ...
                                                    fill="currentColor" class="android__layer-2" />
                                                <path
                                                    ...
                                                    fill="currentColor" class="android__layer-3" />
                                                <path
                                                    ...
                                                    fill="currentColor" class="android__layer-4" />
                                            </svg>
                                            Android </a>
                                    </li>
                                    <li>
                                        <a class="mb-block__link mb-block__link_web js-android-link1"
                                            href="https://potradeweb.onelink.me/1hUA/i5bnc13s" data-name="svg-link"
                                            target="_blank"
                                            data-layout='{"event":"gtm_events","ga4_event_name":"go_to_store_from_menu","store_name":"apk"}'>
                                            <svg class="svg-icon apk" viewBox="0 0 64 64" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        <a class="mb-block__link mb-block__link_web js-android-link1"
                                            ...
                                            <svg class="svg-icon web" viewBox="0 0 64 64" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M33.1814 61.5384H30.8183C17.4508 61.5384 10.767 61.5384 6.61419 57.3856C2.46143 53.2329 2.46143 46.5489 2.46143 33.1814V30.8183C2.46143 17.4506 2.46142 10.7668 6.61419 6.61408C10.767 2.46155 17.4508 2.46155 30.8183 2.46155H33.1814C46.5489 2.46155 53.2328 2.46155 57.3854 6.61408C61.5383 10.7668 61.5383 17.4506 61.5383 30.8183V33.1814C61.5383 46.5489 61.5383 53.2329 57.3854 57.3856C53.2328 61.5384 46.5489 61.5384 33.1814 61.5384ZM32.9846 56.6152H31.0154C19.8758 56.6152 14.3059 56.6152 10.8453 53.8467C7.38464 51.0782 7.38464 46.6222 7.38464 37.7106L7.38454 22.1521C7.3845 19.4331 9.58729 17.2307 12.3062 17.2307L51.6932 17.2307C54.4121 17.2307 56.6153 19.4331 56.6153 22.152V37.7106C56.6153 46.6222 56.6153 51.0782 53.1546 53.8467C49.6941 56.6152 44.1242 56.6152 32.9846 56.6152ZM27.0768 9.84615C28.4355 9.84615 29.5383 10.9489 29.5383 12.3077C29.5383 13.6665 28.4355 14.7692 27.0768 14.7692C25.718 14.7692 24.6152 13.6665 24.6152 12.3077C24.6152 10.9489 25.718 9.84615 27.0768 9.84615ZM22.1537 12.3077C22.1537 10.949 21.0509 9.8462 19.6922 9.8462C18.3334 9.8462 17.2306 10.949 17.2306 12.3077C17.2306 13.6665 18.3334 14.7693 19.6922 14.7693C21.0509 14.7693 22.1537 13.6665 22.1537 12.3077ZM14.7691 12.3078C14.7691 10.949 13.6663 9.84621 12.3076 9.84621C10.9488 9.84621 9.84603 10.949 9.84603 12.3078C9.84603 13.6665 10.9488 14.7693 12.3076 14.7693C13.6663 14.7693 14.7691 13.6665 14.7691 12.3078Z"
                                                    fill="currentColor" />
                                                <path
                                                    d="M19.5029 30.1064C19.5029 29.479 20.0116 28.9703 20.639 28.9703C21.2665 28.9703 21.7751 29.479 21.7751 30.1064V48.2839C21.7751 48.9114 21.2665 49.42 20.639 49.42C20.0116 49.42 19.5029 48.9114 19.5029 48.2839V30.1064Z"
                                                    fill="currentColor" />
                                                <path
                                                    d="M30.8638 23.2899C30.8638 22.6625 31.3724 22.1538 31.9999 22.1538C32.6273 22.1538 33.136 22.6625 33.136 23.2899V46.0118C33.136 46.6392 32.6273 47.1479 31.9999 47.1479C31.3724 47.1479 30.8638 46.6392 30.8638 46.0118V23.2899Z"
                                                    fill="currentColor" />
                                                <path
                                                    d="M42.2249 32.3787C42.2249 31.7513 42.7335 31.2426 43.3609 31.2426C43.9884 31.2426 44.497 31.7513 44.497 32.3787V50.5562C44.497 51.1836 43.9884 51.6923 43.3609 51.6923C42.7335 51.6923 42.2249 51.1836 42.2249 50.5562V32.3787Z"
                                                    fill="currentColor" />
                                                <path
                                                    d="M17.2307 34.7454C17.2307 34.0657 17.7817 33.5146 18.4615 33.5146H22.8165C23.4962 33.5146 24.0473 34.0657 24.0473 34.7454V45.917C24.0473 46.5967 23.4962 47.1478 22.8165 47.1478H18.4615C17.7817 47.1478 17.2307 46.5967 17.2307 45.917V34.7454Z"
                                                    fill="currentColor" />
                                                <path
                                                    d="M28.5916 27.9289C28.5916 27.2492 29.1426 26.6981 29.8223 26.6981H34.1773C34.8571 26.6981 35.4081 27.2492 35.4081 27.9289V43.6448C35.4081 44.3246 34.8571 44.8756 34.1773 44.8756H29.8223C29.1426 44.8756 28.5916 44.3246 28.5916 43.6448V27.9289Z"
                                                    fill="currentColor" />
                                                <path
                                                    d="M39.9526 37.0177C39.9526 36.338 40.5037 35.7869 41.1834 35.7869H45.5384C46.2182 35.7869 46.7692 36.338 46.7692 37.0177V48.1893C46.7692 48.869 46.2182 49.42 45.5384 49.42H41.1834C40.5037 49.42 39.9526 48.869 39.9526 48.1893V37.0177Z"
                                                    fill="currentColor" />
                                            </svg>
                                            Web App </a>
                                    </li>
                                    ...
                                    <li>
                                        <a class="mb-block__link mb-block__link_web js-android-link1"
                                            href="https://appgallery.huawei.com/app/C109751795" data-name="svg-link"
                                            target="_blank"
                                            data-layout='{"event":"gtm_events","ga4_event_name":"go_to_store_from_menu","store_name":"huawei"}'>
                                            <svg class="svg-icon huawei" viewBox="0 0 64 64" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M28.2307 36.7244H30.6024L29.4125 33.9572L28.2307 36.7244Z"
                                                    fill="currentColor" />
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M2.46143 19.0339C2.46143 6.89956 6.90058 2.46118 19.0374 2.46118H44.9623C57.0991 2.46118 61.5383 6.89956 61.5383 19.0339V44.9653C61.5383 57.0996 57.0909 61.538 44.9544 61.538H19.0374C6.90058 61.538 2.46143 57.0996 2.46143 44.9653V19.0339ZM22.1539 11.4867C21.7007 11.4867 21.3334 11.8541 21.3334 12.3072C21.3334 18.1896 26.1171 22.9739 32 22.9739C37.8824 22.9739 42.6667 18.1896 42.6667 12.3072C42.6667 11.8541 42.2993 11.4867 41.8462 11.4867H40.4554C40.0022 11.4867 39.6349 11.8541 39.6349 12.3072C39.6349 16.5159 36.2089 19.9416 32 19.9416C27.7912 19.9416 24.3652 16.5159 24.3652 12.3072C24.3652 11.8541 23.9978 11.4867 23.5447 11.4867H22.1539ZM27.6467 38.119L26.943 39.7291H25.341L28.7478 32H30.1323L33.5254 39.7291H31.8806L31.186 38.119H27.6467ZM53.426 39.7234H54.9744V31.9995H53.426V39.7234ZM47.2633 36.4053H50.1174V34.997H47.2633V33.414H51.4066V32.0052H45.7154V39.7286H51.5557V38.3198H47.2633V36.4053ZM41.1111 37.3179L39.3557 31.9995H38.0746L36.3192 37.3179L34.6108 32.0038H32.9404L35.6364 39.7333H36.9351L38.6933 34.6561L40.4516 39.7333H41.7616L44.4505 32.0038H42.8233L41.1111 37.3179ZM22.9773 36.4267C22.9773 37.684 22.3529 38.3559 21.2191 38.3559C20.079 38.3559 19.4513 37.6646 19.4513 36.3731V32.0047H17.882V36.4267C17.882 38.6018 19.0909 39.8492 21.1977 39.8492C23.3253 39.8492 24.5452 38.5781 24.5452 36.3621V32H22.9773V36.4267ZM14.1381 32H15.7064V39.7338H14.1381V36.5929H10.595V39.7338H9.02572V32H10.595V35.1195H14.1381V32Z"
                                                    fill="currentColor" />
                                            </svg>
                                            Huawei </a>
                                    </li>
                ...
                <div class="social-icons-block">
                    ...
                    <ul class="socials">
                        <li class="socials__item">
                            <a rel="noopener" target="_blank" href="https://www.facebook.com/pocketoptionglobal"
                        ...
                        <li class="socials__item">
                            <a rel="noopener" target="_blank" href="https://t.me/pocketoption"
                                class="socials__icon socials__icon--tg">
                                <svg class="svg-icon" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <li class="socials__item">
                            <a rel="noopener" target="_blank" href="https://www.instagram.com/pocketoptionofficial"
                                class="socials__icon socials__icon--ig">
                                <svg class="svg-icon" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="socials__item">
                            <a rel="noopener" target="_blank" href="https://twitter.com/pobroker"
                        ...
                        <li class="socials__item">
                            <a rel="noopener" target="_blank" href="https://www.youtube.com/@pocketoption"
                        ...
                        <li class="socials__item">
                            <a rel="noopener" target="_blank" href="https://discord.gg/yvFNE3esbH"
                                class="socials__icon socials__icon--ds">
                                <svg class="svg-icon" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="socials__item">
                            <a rel="noopener" target="_blank" href="https://www.tiktok.com/@pocketoptionofficial"
                                class="socials__icon socials__icon--tt">
                                <svg class="svg-icon" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
    ...
    <div class="layout ">
                ...
                <div class="content">
                    <a href="https://m.pocketoption.com/en/" class="header__logo logo ">
                        <svg width="210" height="30" viewBox="0 0 210 30" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="#1A4DDE" />
                            <path fill-rule="evenodd" clip-rule="evenodd" class="logo__letter-1"
                                ...
                                fill="currentColor" />
                            <path fill-rule="evenodd" clip-rule="evenodd" class="logo__letter-2"
                    ...
                    <div class="header__info info">
                        ...
                        <div class="info__text">
                            Optimized charts rendering engine reduces loading time and <span>increases battery life up
                                to 25%.</span> </div>
                    </div>
                    <a class="new-year-2024-header-btn js-ny-header-btn">
                        <img src="/images/new-year-2024/site/btn/btn.png"
                            srcset="/images/new-year-2024/site/btn/btn.png 1x,/images/new-year-2024/site/btn/btn@2x.png 2x"
                            alt=""> </a>
            ...
            <div class="container">
                ...
                <div class="header-mobile__center">
                    <a href="https://m.pocketoption.com/en/" class="header__logo logo">
                        <picture class="">
                            <source
                                srcset="themes/2017-09/img/logo-mobile.webp 1x, themes/2017-09/img/logo-mobile@2x.webp 2x"
                                type="image/webp">
                            <source
                                srcset="themes/2017-09/img/logo-mobile.png 1x, themes/2017-09/img/logo-mobile@2x.png 2x"
                                type="image/png">
                            <img src="themes/2017-09/img/logo-mobile.png" data-src="themes/2017-09/img/logo-mobile.png"
                                data-srcset="themes/2017-09/img/logo-mobile.png 1x, themes/2017-09/img/logo-mobile@2x.png 2x"
                ...
                <div class="header-mobile__right">
                    <a href="{{route('login')}}" class="btn btn_white header-mobile__btn">Log In</a>
                </div>
            </div>
        </header>
        <main>
                ...
                <div class="container main-slider__container">
                    <div class="main-slider__bg bg">
                        <picture class="bg__item bg__item_candles">
                            <source srcset="themes/2017-09/img/header-bg-1.webp" type="image/webp">
                            <img src="themes/2017-09/img/header-bg-1.png" alt="">
                        </picture>
                        <picture class="bg__item bg__item_phone">
                            <source srcset="themes/2017-09/img/header-bg-2.webp" type="image/webp">
                            <img src="themes/2017-09/img/header-bg-2.png" alt="">
                        </picture>
                        <picture class="bg__item bg__item_note">
                            <source srcset="themes/2017-09/img/header-bg-3_1.webp" media="(max-width: 550px)"
                                type="image/webp">
                            <source srcset="themes/2017-09/img/header-bg-3_1.png" media="(max-width: 550px)"
                                type="image/jpeg">

                            <source srcset="themes/2017-09/img/header-bg-3_2.webp" media="(max-width: 1024px)"
                                type="image/webp">
                            <source srcset="themes/2017-09/img/header-bg-3_2.png" media="(max-width: 1024px)"
                                type="image/jpeg">

                            <img src="themes/2017-09/img/header-bg-3.png" alt="">
                        </picture>
                        <div class="bg__item bg__item_gradient"></div>
                    </div>
                    <div class="content main-slider__content">
                        <div class="main-slider__in">
                            <div class="new-year-2024-banner">
                                <div class="new-year-2024-banner__in">
                                    <div class="new-year-2024-banner__bg"
                                        style="background-image: url(/images/new-year-2024/site/banner/bg.png)"></div>
                                    <div class="new-year-2024-banner__start">
                                        <img class="pc" src="/images/new-year-2024/site/banner/pc.jpg"
                                            srcset="/images/new-year-2024/site/banner/pc.jpg 1x,/images/new-year-2024/site/banner/pc@2x.jpg 2x"
                                            alt=""> <img class="mob" src="/images/new-year-2024/site/banner/mob.jpg"
                                            srcset="/images/new-year-2024/site/banner/mob.jpg 1x,/images/new-year-2024/site/banner/mob@2x.jpg 2x"
                                            alt="">
                                    </div>
                                    <div class="new-year-2024-banner__center">
                                        <div class="new-year-2024-banner__title">
                                            New Year Pocket Celebration '25 </div>
                                        <div class="new-year-2024-banner__text js-btn-blocks hidden">
                                            Tap the button to be among the first to receive updates about the promo
                                            launch and full details on how to join. </div>
                                        <div class="new-year-2024-banner__text js-timer-blocks">
                                    ...
                                    <div class="new-year-2024-banner__end">
                                        <div class="new-year-2024-banner__timer js-timer-blocks">
                                            <div class="new-year-2024-banner__timer-start">
                                                Time left until the end:
                                            </div>
                                            <div class="new-year-2024-banner__timer-end">
                                                <div class="new-year-2024-timer">
                                                    <div class="new-year-2024-timer__item">
                                                        <div class="new-year-2024-timer__nums">
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-d1">
                                                                &nbsp;</div>
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-d2">
                                                                &nbsp;</div>
                                                        </div>
                                                        <div class="new-year-2024-timer__text">
                                                            days </div>
                                                    </div>
                                                    <div class="new-year-2024-timer__item">
                                                        <div class="new-year-2024-timer__nums">
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-h1">
                                                                &nbsp;</div>
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-h2">
                                                                &nbsp;</div>
                                                        </div>
                                                        <div class="new-year-2024-timer__text">
                                                            hours </div>
                                                    ...
                                                    <div class="new-year-2024-timer__item">
                                                        <div class="new-year-2024-timer__nums">
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-m1">
                                                                &nbsp;</div>
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-m2">
                                                                &nbsp;</div>
                                                        </div>
                                                        <div class="new-year-2024-timer__text">
                                                            minutes </div>
                                                    ...
                                                    <div class="new-year-2024-timer__item">
                                                        <div class="new-year-2024-timer__nums">
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-s1">
                                                                &nbsp;</div>
                                                            <div
                                                                class="new-year-2024-timer__num js-new-year-2024-timer-s2">
                                                                &nbsp;</div>
                                                        </div>
                                                        <div class="new-year-2024-timer__text">
                                                            seconds </div>
                                                ...
                                                <script>
                                                    (function(timerDateCurrent, timerDateEnd){

        const ny2024d1 = document.querySelector('.js-new-year-2024-timer-d1');
        const ny2024d2 = document.querySelector('.js-new-year-2024-timer-d2');
        const ny2024h1 = document.querySelector('.js-new-year-2024-timer-h1');
        const ny2024h2 = document.querySelector('.js-new-year-2024-timer-h2');
        const ny2024m1 = document.querySelector('.js-new-year-2024-timer-m1');
        const ny2024m2 = document.querySelector('.js-new-year-2024-timer-m2');
        const ny2024s1 = document.querySelector('.js-new-year-2024-timer-s1');
        const ny2024s2 = document.querySelector('.js-new-year-2024-timer-s2');

        function padZero(number) {
            return number.toString().padStart(2, '0');
        }

        function toCharArray(number) {
            return padZero(number).split('');
        }
        ...
        function calculateTimeDifference(start, end) {
            ...
            const seconds = toCharArray(Math.floor((difference / 1000) % 60));
            const minutes = toCharArray(Math.floor((difference / 1000 / 60) % 60));
            const hours = toCharArray(Math.floor((difference / 1000 / 60 / 60) % 24));
            const days = toCharArray(Math.floor(difference / 1000 / 60 / 60 / 24));
        ...
        function startCountdown() {
            function intervalFn() {
                // Уменьшаем текущую дату на 1 секунду
                timerDateCurrent = new Date(timerDateCurrent.getTime() + 1000);

                // Вычисляем разницу между текущей и конечной датами
                const timeDifference = calculateTimeDifference(timerDateCurrent, timerDateEnd);

                if (ny2024d1 && ny2024d2) {
                    ny2024d1.innerText = timeDifference.days[0];
                    ny2024d2.innerText = timeDifference.days[1];
                }
                if (ny2024h1 && ny2024h2) {
                    ny2024h1.innerText = timeDifference.hours[0];
                    ny2024h2.innerText = timeDifference.hours[1];
                }
                if (ny2024m1 && ny2024m2) {
                    ny2024m1.innerText = timeDifference.minutes[0];
                    ny2024m2.innerText = timeDifference.minutes[1];
                }
                if (ny2024s1 && ny2024s2) {
                    ny2024s1.innerText = timeDifference.seconds[0];
                    ny2024s2.innerText = timeDifference.seconds[1];
                }

                // Если время истекло, останавливаем таймер
                if (timerDateCurrent >= timerDateEnd) {
                    clearInterval(timer);
                    if (ny2024d1 && ny2024d2) {
                        ny2024d1.innerText = 0;
                        ny2024d2.innerText = 0;
                    }
                    if (ny2024h1 && ny2024h2) {
                        ny2024h1.innerText = 0;
                        ny2024h2.innerText = 0;
                    }
                    if (ny2024m1 && ny2024m2) {
                        ny2024m1.innerText = 0;
                        ny2024m2.innerText = 0;
                    }
                    if (ny2024s1 && ny2024s2) {
                        ny2024s1.innerText = 0;
                        ny2024s2.innerText = 0;
                    }
                }
            }
            const timer = setInterval(intervalFn, 1000);
            intervalFn();
        }

        startCountdown();

    })(new Date("2024-12-20 11:55:46"), new Date("2024-12-26 00:00:00"));

                                                </script>

                                            </div>
                                        </div>
                                        <div class="new-year-2024-banner__btn-wrap js-btn-blocks hidden">
                                            <a class="new-year-2024-btn js-new-year-2024-participate-btn"
                                                data-is-logged-in="false">
                                                <div class="new-year-2024-btn__in">
                                                    <div class="new-year-2024-btn__icon">
                                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                d="M10.6024 7.19211H7.03123C6.82162 6.92236 6.66813 6.54424 6.63564 6.17698C6.60339 5.81252 6.69412 5.55893 6.83398 5.40386C6.96458 5.25904 7.28485 5.03724 8.061 5.03724C8.76981 5.03724 9.49759 5.52049 10.1154 6.3778C10.3104 6.64843 10.4721 6.92615 10.6024 7.19211ZM4.5068 6.36533C4.53154 6.64485 4.58709 6.923 4.66945 7.19211H3.82411C3.03724 7.19211 2.39935 7.83 2.39935 8.61687V9.87364C2.39935 10.6605 3.03724 11.2984 3.82411 11.2984H20.3564C21.1432 11.2984 21.7812 10.6605 21.7812 9.87364V8.61687C21.7812 7.83 21.1432 7.19211 20.3564 7.19211H19.511C19.5935 6.923 19.6489 6.64485 19.6737 6.36533C19.7434 5.57853 19.5724 4.68087 18.9335 3.97253C18.2854 3.25389 17.3099 2.90009 16.1195 2.90009C14.4107 2.90009 13.1238 4.02856 12.3313 5.12838C12.2478 5.24416 12.1674 5.36298 12.0903 5.4841C12.0131 5.36298 11.9327 5.24416 11.8492 5.12838C11.0567 4.02856 9.76981 2.90009 8.061 2.90009C6.87061 2.90009 5.89507 3.25389 5.24694 3.97253C4.60809 4.68087 4.43719 5.57853 4.5068 6.36533ZM13.5781 7.19211H17.1493C17.3589 6.92236 17.5123 6.54424 17.5448 6.17698C17.5772 5.81252 17.4864 5.55893 17.3465 5.40386C17.216 5.25904 16.8957 5.03724 16.1195 5.03724C15.4107 5.03724 14.6829 5.52049 14.0651 6.3778C13.8701 6.64843 13.7084 6.92615 13.5781 7.19211ZM3.82411 13.0793H11.1998V22.1006H5.18522C4.39835 22.1006 3.76046 21.4628 3.76046 20.6759V13.0787C3.78163 13.0791 3.80286 13.0793 3.82411 13.0793ZM18.9949 22.1006H12.9807V13.0793H20.3564C20.3775 13.0793 20.3986 13.0791 20.4197 13.0787V20.6759C20.4197 21.4628 19.7818 22.1006 18.9949 22.1006Z"
                                                                fill="currentColor" />
                                                        </svg>
                                                    </div>
                                                    <div class="new-year-2024-btn__text">
                                                        Participate </div>
                                                </div>
                                            </a>
                                        </div>
                            ...
                            <div class="main-slider__text-wrap">
                                ...
                                <div class="main-slider__btn-container">
                                    <a href="{{route('register')}}"
                                        class="btn btn_blue-gradient register-btn main-slider__btn">
                                        Registration </a>
                                </div>
                    ...
                    <div class="content">
                        <div class="conditions__in">
                            ...
                            <div class="monitor">
                                <picture class="">
                                    <source
                                        srcset="themes/2017-09/img/monitor.webp 1x, themes/2017-09/img/monitor@2x.webp 2x"
                                        type="image/webp">
                                    <source
                                        srcset="themes/2017-09/img/monitor.png 1x, themes/2017-09/img/monitor@2x.png 2x"
                                        type="image/png">
                                    <img src="themes/2017-09/img/monitor.png" data-src="themes/2017-09/img/monitor.png"
                                        data-srcset="themes/2017-09/img/monitor.png 1x, themes/2017-09/img/monitor@2x.png 2x"
                        ...
                        <ul class="why-list">
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--flexible-trading"
                                    href="https://m.pocketoption.com/en/cabinet/high-low/">
                                    <img src="themes/2017-09/img/why-we/1.svg" alt="Icon 1" class="lazy"
                                        loading="lazy" />
                                    <p class="why-list__title">Flexible Trading</p>
                                    <p class="why-list__sub-title">Latest trends: quick and digital trading, express
                                        trades, Forex MT5, pending orders, trades copying. Payouts up to 218%.</p>
                                </a>
                            </li>
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--education"
                                    href="https://m.pocketoption.com/en/cabinet/platform-guide/">
                                    <img src="themes/2017-09/img/why-we/2.svg" alt="Icon 2" class="lazy"
                                        loading="lazy" />
                                    <p class="why-list__title">Comprehensive Education</p>
                                    <p class="why-list__sub-title">Our help section contains tutorials, guides and
                                        various trading strategies.</p>
                                </a>
                            </li>
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--diverse-trading-instruments"
                                    ...
                                    <p class="why-list__sub-title">Assets suitable for any trader: currency,
                                        commodities, stocks.</p>
                                </a>
                            </li>
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--demo-account" href="{{ route('register') }}">
                                    ...
                                    <p class="why-list__sub-title">Try all platform benefits on the Demo account using
                                        virtual money. No investment needed, no risks involved.</p>
                                </a>
                            </li>
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--deposit-withdrawals"
                                    href="https://m.pocketoption.com/en/payment-methods/">
                                    <img src="themes/2017-09/img/why-we/5.svg" alt="Icon 5" class="lazy"
                                        loading="lazy" />
                                    <p class="why-list__title">Easy Deposits and Withdrawals</p>
                                    <p class="why-list__sub-title">Use the most convenient payment method for
                                        hassle-free deposits and withdrawals.</p>
                                </a>
                            </li>
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--high-customer-loyalty"
                                    href="https://m.pocketoption.com/en/cabinet/high-low/">
                                    <img src="themes/2017-09/img/why-we/6.svg" alt="Icon 6" class="lazy"
                                        loading="lazy" />
                                    <p class="why-list__title">High Customer Loyalty</p>
                                    <p class="why-list__sub-title">Trading tournaments, regular bonuses, gifts, promo
                                        codes and contests are available to any trader.</p>
                                </a>
                            </li>
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--trading-advantages"
                                    href="https://m.pocketoption.com/en/cabinet/profile/achievements/market/">
                                    <img src="themes/2017-09/img/why-we/7.svg" alt="Icon 7" class="lazy"
                                        loading="lazy" />
                                    <p class="why-list__title">Trading Advantages</p>
                                    <p class="why-list__sub-title">Use cashback and other advantages for a more
                                        comfortable trading experience with minimal risks.</p>
                                </a>
                            </li>
                            <li class="why-list__item">
                                <a class="why-list__link why-list__link--indicators-and-signals"
                                    href="https://m.pocketoption.com/en/cabinet/high-low/#open-chart-settings-indicators-modal">
                                    <img src="themes/2017-09/img/why-we/8.svg" alt="Icon 8" class="lazy"
                                        loading="lazy" />
                                    <p class="why-list__title">Indicators and Signals</p>
                                    <p class="why-list__sub-title">Everything you need for a top-tier trading experience
                                        including popular indicators and signals.</p>
                                </a>
                            </li>
                ...
                <div class="container">
                    <div class="content offers__in">
                        <div class="slider__arrows">
                            <a class="slider__arrow arrow arrow-left"><svg width="13" height="22" viewBox="0 0 13 22"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 1L2 11L12 21" stroke="#96AEC1" stroke-width="2"
                                        class="slider-arrow-stroke" />
                                </svg>
                            </a>
                            <a class="slider__arrow arrow arrow-right"><svg width="13" height="22" viewBox="0 0 13 22"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L11 11L1 21" stroke="#0099FA" stroke-width="2"
                                        class="slider-arrow-stroke" />
                                </svg>
                            </a>
                        </div>
                        <div class="offers__corners">
                            <img src="themes/2017-09/img/offers-slider/corner-1.png"
                                class="offers__corner offers__corner_1" alt="" loading="lazy">
                            <img src="themes/2017-09/img/offers-slider/corner-2.png"
                                class="offers__corner offers__corner_2" alt="" loading="lazy">
                            <img src="themes/2017-09/img/offers-slider/corner-3.png"
                                class="offers__corner offers__corner_3" alt="" loading="lazy">
                            <img src="themes/2017-09/img/offers-slider/corner-4.png"
                                class="offers__corner offers__corner_4" alt="" loading="lazy">
                        </div>
                        <div class="offers__list" style="--count-items: 4">
                            <a href="https://m.pocketoption.com/en/payment-methods/"
                                ...
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/card.webp 1x, themes/2017-09/img/offers-slider/card@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/card.png 1x, themes/2017-09/img/offers-slider/card@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/card_s.webp 1x, themes/2017-09/img/offers-slider/card_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/card_s.png 1x, themes/2017-09/img/offers-slider/card_s@2x.png 2x"
                                                type="image/png">
                            ...
                            <a href="https://m.pocketoption.com/en/assets-current/"
                                class="offers__item offers__item_trading-assets">
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/trade.webp 1x, themes/2017-09/img/offers-slider/trade@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/trade.png 1x, themes/2017-09/img/offers-slider/trade@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/trade_s.webp 1x, themes/2017-09/img/offers-slider/trade_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/trade_s.png 1x, themes/2017-09/img/offers-slider/trade_s@2x.png 2x"
                                                type="image/png">
                            ...
                            <a href="https://m.pocketoption.com/en/cabinet/profile/achievements/" target="_blank"
                                class="offers__item offers__item_achievements">
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/archi.webp 1x, themes/2017-09/img/offers-slider/archi@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/archi.png 1x, themes/2017-09/img/offers-slider/archi@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/archi_s.webp 1x, themes/2017-09/img/offers-slider/archi_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/archi_s.png 1x, themes/2017-09/img/offers-slider/archi_s@2x.png 2x"
                                                type="image/png">
                            ...
                            <a href="https://m.pocketoption.com/en/cabinet/applications/" target="_blank"
                                class="offers__item offers__item_apps">
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/app.webp 1x, themes/2017-09/img/offers-slider/app@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/app.png 1x, themes/2017-09/img/offers-slider/app@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/app_s.webp 1x, themes/2017-09/img/offers-slider/app_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/app_s.png 1x, themes/2017-09/img/offers-slider/app_s@2x.png 2x"
                                                type="image/png">
                            ...
                            <a href="#" target="_blank"
                                ...
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/feedback.webp 1x, themes/2017-09/img/offers-slider/feedback@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/feedback.png 1x, themes/2017-09/img/offers-slider/feedback@2x.png 2x"
                                                type="image/png">
                                            <img src="themes/2017-09/img/offers-slider/feedback.png"
                                                data-src="themes/2017-09/img/offers-slider/feedback.png"
                                                srcset="themes/2017-09/img/offers-slider/feedback.png 1x, themes/2017-09/img/offers-slider/feedback@2x.png 2x"
                                                alt="Feedback icon" />
                                        </picture>
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/feedback_s.webp 1x, themes/2017-09/img/offers-slider/feedback_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/feedback_s.png 1x, themes/2017-09/img/offers-slider/feedback_s@2x.png 2x"
                                                type="image/png">
                                            <img src="themes/2017-09/img/offers-slider/feedback_s.png"
                                                data-src="themes/2017-09/img/offers-slider/feedback_s.png"
                                                srcset="themes/2017-09/img/offers-slider/feedback_s.png 1x, themes/2017-09/img/offers-slider/feedback_s@2x.png 2x"
                                                alt="Feedback icon" />
                                        </picture>
                                    </div>
                            ...
                            <a href="https://m.pocketoption.com/en/cabinet/platform-guide/#indicators" target="_blank"
                                class="offers__item offers__item_tech-analysis">
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/analytic.webp 1x, themes/2017-09/img/offers-slider/analytic@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/analytic.png 1x, themes/2017-09/img/offers-slider/analytic@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/analytic_s.webp 1x, themes/2017-09/img/offers-slider/analytic_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/analytic_s.png 1x, themes/2017-09/img/offers-slider/analytic_s@2x.png 2x"
                                                type="image/png">
                            ...
                            <a href="https://m.pocketoption.com/en/cabinet/platform-guide/#enabling-trading-signals"
                                target="_blank" class="offers__item offers__item_signals">
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/signal.webp 1x, themes/2017-09/img/offers-slider/signal@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/signal.png 1x, themes/2017-09/img/offers-slider/signal@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/signal_s.webp 1x, themes/2017-09/img/offers-slider/signal_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/signal_s.png 1x, themes/2017-09/img/offers-slider/signal_s@2x.png 2x"
                                                type="image/png">
                            ...
                            <a href="https://m.pocketoption.com/en/cabinet?openRoom=14906/" target="_blank"
                                class="offers__item offers__item_community">
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/comm.webp 1x, themes/2017-09/img/offers-slider/comm@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/comm.png 1x, themes/2017-09/img/offers-slider/comm@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/comm_s.webp 1x, themes/2017-09/img/offers-slider/comm_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/comm_s.png 1x, themes/2017-09/img/offers-slider/comm_s@2x.png 2x"
                                                type="image/png">
                            ...
                            <a href="https://pocket-land.com/en/land/010-QT-01" target="_blank"
                                class="offers__item offers__item_social-trading">
                                <div class="offers__col">
                                    <div class="offers__img-wrap">
                                        <picture class="offers__img offers__img_no-shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/copy.webp 1x, themes/2017-09/img/offers-slider/copy@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/copy.png 1x, themes/2017-09/img/offers-slider/copy@2x.png 2x"
                                                type="image/png">
                                        ...
                                        <picture class="offers__img offers__img_shine">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/copy_s.webp 1x, themes/2017-09/img/offers-slider/copy_s@2x.webp 2x"
                                                type="image/webp">
                                            <source
                                                srcset="themes/2017-09/img/offers-slider/copy_s.png 1x, themes/2017-09/img/offers-slider/copy_s@2x.png 2x"
                                                type="image/png">
                ...
                <div class="container container__no-padding">
                    <div class="content check-your-luck__in">
                        <div class="check-your-luck__left">
                            ...
                            <p class="title-desc">
                                Enter your email address and get a special offer from Pocket Option. If luck is on your
                                side, you will receive a free gift! </p>
                        </div>
                    ...
                    <div class="content applications__in">
                        ...
                        <ul class="devices">
                            <li class="devices__item">
                                <a href="https://apps.apple.com/gb/app/p%C3%B6cke%E1%B9%AB-%CF%8C%CF%81ti%E1%BB%8D%C5%8B-moneytracker/id6738608368"
                                    target="_blank" class="devices__btn devices__btn_ios js-ios-link"
                                    data-name="svg-link"
                                    data-layout='{"event":"gtm_events","ga4_event_name":"go_to_store_from_main","store_name":"ios"}'>
                            ...
                            <li class="devices__item">
                                <a href="https://play.google.com/store/apps/details?id=com.potradeweb" target="_blank"
                                    class="devices__btn devices__btn_ios js-android-link" data-name="svg-link"
                            ...
                            <li class="devices__item">
                                <a href="https://potradeweb.onelink.me/1hUA/i5bnc13s" target="_blank"
                                    class="devices__btn devices__btn_ios js-apk-link" data-name="svg-link"
                            ...
                            <li class="devices__item">
                                <a href="https://m.pocketoption.com/cabinet/telegram/link" target="_blank"
                                    class="devices__btn devices__btn_ios js-tg-link" data-name="svg-link"
                                    data-layout='{"event":"gtm_events","ga4_event_name":"go_to_store_from_main","store_name":"telegram"}'>
                                    <div class="devices__top">
                                        <svg class="svg-icon tg" viewBox="0 0 64 64" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="devices__item">
                                <a href="https://appgallery.huawei.com/app/C109751795" target="_blank"
                                    class="devices__btn devices__btn_ios js-huawei-link" data-name="svg-link"
                                    data-layout='{"event":"gtm_events","ga4_event_name":"go_to_store_from_main","store_name":"huawei"}'>
                                    <div class="devices__top">
                                        <svg class="svg-icon huawei" viewBox="0 0 64 64" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M28.2307 36.7244H30.6024L29.4125 33.9572L28.2307 36.7244Z"
                        ...
                        <div class="phone-container">
                            <picture class="phone phone_android">
                                <source
                                    srcset="themes/2017-09/img/apps/android-img.webp?v=1 1x, themes/2017-09/img/apps/android-img@2x.webp?v=1 2x"
                                    type="image/webp">
                                <source
                                    srcset="themes/2017-09/img/apps/android-img.png?v=1 1x, themes/2017-09/img/apps/android-img@2x.png?v=1 2x"
                                    type="image/png">
                                <img src="themes/2017-09/img/apps/android-img.png?v=1"
                            ...
                            <picture class="phone phone_iphone">
                                ...
                                <source
                                    ...
                                    type="image/png">
                                <img src="themes/2017-09/img/apps/iphone-img.png?v=1"
            ...
            <section class="section section_light reviews-slider">
                <div class="container reviews-slider__container">
                    <div class="content reviews-slider__in">
                        ...
                        <p class="reviews-slider__title-desc">More than 10 million customers worldwide trust us and earn
                            daily.</p>
                        <div class="js-reviews-slider slider">
                            <div class="slider__left">
                                    ...
                                    <div class="rv-slider">
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                <div class="review-item__stars"
                                                    style="cursor: default; user-select: none; display: block; white-space: nowrap;">
                                                    <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                                                </div>
                                                <div class="review-item__date">2024-12-15 18:24:43</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">You can't really appreciate the
                                                    awesome atmosphere this company has created for the</span><span
                                                    class="js-review-text-next"> traders except you have taken part of
                                                    this experience. Never judge a book by its cover! All the services
                                                    offered will make you feel at home! I love you guys! Keep it
                                                    up!</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/tg.svg"
                                                        alt="Togo">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=73831291"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Yao Mawuy. D. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=73831291"
                                                            class="js-link-with-get-param" target="_blank">UID
                                                            73831291</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-12-15 16:48:22</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Pocketoption is a unique platform with
                                                    a lot of features.it is the best binary platform</span><span
                                                    class="js-review-text-next"> with nice tournament.its interface is
                                                    user friendly and easy to use</span><span
                                                    class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/ng.svg"
                                                        alt="Nigeria">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=78528141"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Precious . O. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-12-14 21:15:30</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Am impressed with the easiness is
                                                    trading. Trading Bot can actually make money for you if</span><span
                                                    class="js-review-text-next"> you have sufficient float. Deposit and
                                                    withdrawal is real time in most cases. Winning is real here
                                                    too.</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/ke.svg"
                                                        alt="Kenya">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=88259220"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Brenda An. O. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-12-13 12:56:31</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Had I known I would have come earlier.
                                                    Pocket Option is the better option for you and I.</span><span
                                                    class="js-review-text-next"> Seen is believe. Tested &
                                                    Trusted!</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/so.svg"
                                                        alt="Somalia">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=73287650"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Ahmed Ade. A. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-12-12 11:28:09</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">This is the best platform Ever for
                                                    Binary Trading, Everything is good deposit,</span><span
                                                    class="js-review-text-next"> withdrawal, and off course the support
                                                    system are Very very very Good ????, I Loved It.</span><span
                                                    class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/np.svg"
                                                        alt="Nepal">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=79030344"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Jiwan Lal Y. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-12-04 12:59:37</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Pocket Option presents itself as a
                                                    user-friendly platform for trading binary options and</span><span
                                                    class="js-review-text-next"> other financial instruments. However,
                                                    it's important to approach this platform with caution and a clear
                                                    understanding of the risks involved.

                                                    Pros:

                                                    User-friendly interface: The platform boasts a simple design, making
                                                    it accessible to both novice and experienced traders.</span><span
                                                    class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/pk.svg"
                                                        alt="Pakistan">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=88197810"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Syed Imda. S. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-30 21:17:37</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">This platform is the best platform i
                                                    have ever used easy to get understanding how the</span><span
                                                    class="js-review-text-next"> market behaves... 2 promocodes every
                                                    week which really helps to improve trading skills and in making
                                                    profit</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=88813820"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Shamim A. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-28 14:42:12</div>
                                            </div>
                                            <div class="review-item__text">
                                                PO trade is the best platform in the world and the team very helpful for
                                                members </div>
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=79630141"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Sami U. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-27 08:23:34</div>
                                            </div>
                                            <div class="review-item__text">
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/mx.svg"
                                                        alt="Mexico">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=88529570"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Angel H. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-24 11:23:40</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Pocket option is my favorite broker
                                                    where I can trade most of the best pairs and best</span><span
                                                    class="js-review-text-next"> payout in the market they have friendly
                                                    tools and even AI trading that can really make you
                                                    profitable</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/dz.svg"
                                                        alt="Algeria">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=79146434"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Missoum R. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-24 08:08:20</div>
                                            </div>
                                            <div class="review-item__text">
                                                It has changed my life positively </div>
                                            <div class="review-item__footer">

                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/ug.svg"
                                                        alt="Uganda">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=80044104"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Enid N. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-22 19:13:00</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Well if you want to experience the
                                                    best tools and speed of trading in the market you’re</span><span
                                                    class="js-review-text-next"> in the right place with pocket option
                                                    you will trade with confidence and trust of everything love this
                                                    brok</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/sa.svg"
                                                        alt="Saudi Arabia">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=84175252"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Mjeed K. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-22 06:26:55</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Pocket Option overall, I’m pretty
                                                    impressed! The platform is super easy to use, even</span><span
                                                    class="js-review-text-next"> for someone like me who’s not a pro
                                                    trader. They have a demo account that really helped me get the hang
                                                    of things before putting in real money.

                                                    What I love most is the variety of assets available—you can trade
                                                    forex, stocks, cryptos, and more. Plus, they have this cool social
                                                    trading feature where you can copy the trades of successful traders.
                                                    It’s been a game-changer for me.

                                                    Their customer support is pretty solid too. They were quick and
                                                    helpful.

                                                    It’s been a great experience so far!

                                                    Would definitely recommend Pocket Option to anyone looking to start
                                                    trading or even seasoned traders wanting a fresh
                                                    platform.</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/ph.svg"
                                                        alt="Philippines">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=88723003"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Rogel G. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-21 01:02:55</div>
                                            </div>
                                            <div class="review-item__text">
                                                ...
                                                <span class="js-review-text-prev">Well if you want to experience the
                                                    ...
                                                    class="js-review-text-next"> in the right place with pocket option
                                                    you will trade with confidence and trust of everything love this
                                                    broker</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=70424512"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Siham K. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-19 17:54:39</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">PO TRADE is the best trading platform
                                                    And support team very helpful.
                                                    Thank you❤ PO</span><span class="js-review-text-next"> TRADE
                                                    team.</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__flag">
                                                    <img class="review-item__flag-img" src="/images/flags-svg/in.svg"
                                                        alt="India">
                                                </div>
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">

                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=72330265"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Arun Kuma. R. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-18 09:58:59</div>
                                            </div>
                                            <div class="review-item__text">
                                                Perfect place for effective and affordable treading app </div>
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=78076055"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Chibueze . I. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-14 11:16:24</div>
                                            </div>
                                            <div class="review-item__text">
                                                Very good for trading, deposit and withdrawal </div>
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=24771119"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Shobha C. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-13 06:57:21</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">I barely write reviews about brokers
                                                    but this one is my first review because I feel</span><span
                                                    class="js-review-text-next"> it’s really worth to tell that pocket
                                                    option is number one in the trading world because they have a super
                                                    fast and very efficient tools in this platform where you can make
                                                    ton of money if you respect rules of trades especially about emotion
                                                    or risk management where pocket option provides limit amount of
                                                    orders if you don’t want to exceed it withdraw is so fast and
                                                    website is number one when it comes to the tools you need them for
                                                    trade plus the execution of trades is right away it’s super fast
                                                    execution love it</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=71315827"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Fouad K. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-11 16:53:32</div>
                                            </div>
                                            <div class="review-item__text">
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=33488343"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Mominul I. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                        ...
                                        <div class="review-item">
                                            <div class="review-item__top">
                                                ...
                                                <div class="review-item__date">2024-11-09 15:53:04</div>
                                            </div>
                                            <div class="review-item__text">

                                                <span class="js-review-text-prev">Pocket option is best broker for forex
                                                    trading. PO gives faster Deposit and withdrawals</span><span
                                                    class="js-review-text-next"> and I have suggestion to traders please
                                                    use Pocket option for best trading journey thanks for all you
                                                    activities.</span><span class="js-review-dots">...</span></br>
                                                <a href="#" class="review-item__more-btn js-show-full-review-btn">Show
                                                    full review</a>
                                                <a href="#" class="review-item__more-btn js-hide-full-review-btn">Hide
                                                    full review</a>
                                            ...
                                            <div class="review-item__footer">
                                                ...
                                                <div class="review-item__user-data">
                                                    <div class="review-item__fio">
                                                        ...
                                                        <a href="https://m.pocketoption.com/en/cabinet/?mo=trading-profile&uid=72753665"
                                                            class="js-link-with-get-param" target="_blank">
                                                            Alh Ahmad. A. </a>
                                                    </div>
                                                    <div class="review-item__uid">
                                ...
                                <div class="slider__arrows">
                                    <a class="slider__arrow arrow arrow-left"><svg width="13" height="22"
                                            viewBox="0 0 13 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 1L2 11L12 21" stroke="#96AEC1" stroke-width="2"
                                                class="slider-arrow-stroke" />
                                        </svg>
                                    </a>
                                    <a class="slider__arrow arrow arrow-right"><svg width="13" height="22"
                                            viewBox="0 0 13 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 1L11 11L1 21" stroke="#0099FA" stroke-width="2"
                                                class="slider-arrow-stroke" />
                                        </svg>
                            ...
                            <div class="payment-methods__list">
                                ...
                                <div class="payment-methods__list-item">
                                    <svg width="200" height="100" viewBox="0 0 200 100" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M47.1475 63.3025H39.7357L44.3715 36.7316H51.7829L47.1475 63.3025Z"
                                            fill="currentColor" />
                                        <path
                                            d="M74.0158 37.3812C72.5538 36.8436 70.2351 36.25 67.368 36.25C60.0486 36.25 54.8944 39.868 54.8628 45.0406C54.802 48.857 58.5531 50.9767 61.3586 52.2492C64.2261 53.5494 65.2008 54.3982 65.2008 55.5572C65.1717 57.3372 62.8837 58.1578 60.7498 58.1578C57.7907 58.1578 56.2052 57.7347 53.7956 56.7444L52.8197 56.3199L51.7825 62.2845C53.5208 63.0186 56.7235 63.67 60.0486 63.6986C67.8256 63.6986 72.8886 60.1366 72.9486 54.6243C72.9782 51.5996 70.9975 49.2819 66.7272 47.388C64.1349 46.1722 62.5473 45.3524 62.5473 44.1085C62.5777 42.9776 63.8901 41.8194 66.8164 41.8194C69.2259 41.7626 70.9963 42.2995 72.3374 42.8368L73.0078 43.1189L74.0158 37.3812Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M87.2829 36.7316H93.0159L98.9953 63.3021H92.1327C92.1327 63.3021 91.4611 60.2492 91.2484 59.3163H81.7323C81.4571 60.0226 80.1767 63.3021 80.1767 63.3021H72.3998L83.409 38.9362C84.1718 37.2117 85.515 36.7316 87.2829 36.7316ZM86.8263 46.455C86.8263 46.455 84.4775 52.3629 83.8671 53.8894H90.0277C89.723 52.5609 88.3194 46.2007 88.3194 46.2007L87.8014 43.9112C87.5833 44.5007 87.2678 45.3113 87.0551 45.858C86.9109 46.2286 86.8138 46.4779 86.8263 46.455Z"
                                            fill="currentColor" />
                                        <path
                                            d="M7.622 36.7316H19.5468C21.1631 36.7875 22.4747 37.268 22.9015 38.9651L25.4928 51.1721C25.4932 51.1733 25.4935 51.1745 25.4939 51.1757L26.2871 54.8504L33.5457 36.7316H41.383L29.733 63.2743H21.8952L15.2892 40.1866C13.0098 38.9513 10.4085 37.9579 7.5 37.2684L7.622 36.7316Z"
                                            fill="currentColor" />
                                        <path
                                            d="M149.279 70.3194C149.473 70.4861 149.682 70.6528 149.884 70.8194C145.914 73.4583 141.152 75 136.028 75C122.207 75 111 63.8056 111 50C111 36.1944 122.207 25 136.028 25C141.152 25 145.914 26.5417 149.884 29.1806C149.682 29.3472 149.473 29.5069 149.279 29.6806C143.383 34.8056 139.998 42.2153 139.998 50C139.998 57.7847 143.376 65.1944 149.279 70.3194Z"
                                            fill="currentColor" />
                                        <path
                                            d="M166.965 25C161.841 25 157.079 26.5417 153.109 29.1806C153.311 29.3472 153.52 29.5069 153.714 29.6806C159.61 34.8056 162.995 42.2083 162.995 50C162.995 57.7917 159.617 65.1944 153.721 70.3194C153.527 70.4861 153.318 70.6528 153.116 70.8194C157.086 73.4583 161.848 75 166.972 75C180.793 75 192 63.8056 192 50C192 36.1944 180.786 25 166.965 25Z"
                                            fill="currentColor" />
                                        <path
                                            d="M151.496 30.3542C151.177 30.6042 150.857 30.8681 150.551 31.139C145.274 35.7223 141.937 42.4723 141.937 50.0001C141.937 57.5279 145.274 64.2779 150.551 68.8612C150.857 69.132 151.177 69.389 151.496 69.6459C151.816 69.389 152.136 69.132 152.442 68.8612C157.719 64.2779 161.056 57.5279 161.056 50.0001C161.056 42.4723 157.719 35.7223 152.442 31.139C152.136 30.8681 151.816 30.6112 151.496 30.3542Z"
                                            fill="currentColor" />
                                    </svg>
                                </div>
                                <div class="payment-methods__list-item">
                                ...
                                <div class="payment-methods__list-item">
                                    <svg width="200" height="100" viewBox="0 0 200 100" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M37.0111 65.6455H37.9638L37.0687 69.3541C36.9326 69.8984 36.964 70.3224 37.1446 70.5946C37.3252 70.8668 37.668 71.0029 38.1574 71.0029C38.5977 71.0196 39.0288 70.8744 39.3692 70.5946C39.7149 70.2603 39.9481 69.8268 40.0366 69.3541L40.9264 65.6455H41.8974L40.9892 69.4431C40.8584 70.1586 40.4894 70.8088 39.9424 71.2882C39.3758 71.7225 38.6743 71.943 37.9611 71.9111C37.1446 71.9111 36.5845 71.7148 36.2809 71.3039C35.9773 70.893 35.9171 70.2779 36.1134 69.4588L37.0242 65.6455H37.0111Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M41.7612 71.7539L43.274 65.415L46.1529 69.1367C46.2288 69.244 46.3047 69.3487 46.3806 69.4691C46.4565 69.5895 46.5324 69.7308 46.6214 69.8774L47.6368 65.6558H48.5241L47.0113 71.9816L44.0748 68.1736L43.8393 67.8569C43.7651 67.7431 43.7045 67.621 43.6587 67.4931L42.6537 71.7277H41.7612V71.7539Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M48.4482 71.7436L49.9008 65.6455H50.8691L49.4166 71.7436H48.4482Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M50.7932 71.7436L52.2458 65.6455H55.5591L55.3628 66.4935H53.0178L52.654 68.0062H55.0017L54.7897 68.8673H52.4447L51.7616 71.7279H50.7932V71.7436Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M55.1824 71.7436L56.6349 65.6455H57.6033L56.1507 71.7436H55.1824Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M57.5273 71.7436L58.9825 65.6455H62.2932L62.097 66.4935H59.752L59.3882 68.0219H61.7332L61.5212 68.883H59.1762L58.7077 70.8511H61.0527L60.8407 71.7436H57.5273Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M61.9608 71.754L63.4133 65.6559H64.7219C65.3106 65.6318 65.9001 65.6775 66.4781 65.792C66.7792 65.8672 67.0559 66.0186 67.2816 66.2317C67.5571 66.513 67.7397 66.8719 67.805 67.2602C67.8753 67.7403 67.8495 68.2296 67.7291 68.6997C67.6089 69.2081 67.4045 69.6928 67.1245 70.1339C66.8565 70.5458 66.5053 70.8971 66.0933 71.1651C65.7918 71.3729 65.4534 71.5212 65.0962 71.6022C64.5799 71.7092 64.0529 71.7549 63.5259 71.7383H61.9556V71.754H61.9608ZM63.1412 70.8484H63.9577C64.3031 70.8579 64.6484 70.8263 64.9863 70.7542C65.2202 70.695 65.4412 70.5929 65.638 70.4532C65.9133 70.2557 66.1449 70.0036 66.3184 69.7125C66.5112 69.394 66.6492 69.0455 66.7267 68.6814C66.8173 68.3518 66.8431 68.0079 66.8026 67.6685C66.7682 67.394 66.6524 67.1361 66.4702 66.9279C66.3304 66.7761 66.1479 66.6702 65.9468 66.6243C65.5941 66.5508 65.2338 66.5201 64.8737 66.5327H64.1776L63.149 70.8484H63.1412Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M72.1732 69.0059L71.5241 71.754H70.616L72.0685 65.6559H73.5368C73.8509 65.6481 74.1649 65.6735 74.4737 65.7318C74.6507 65.7649 74.8143 65.8485 74.9448 65.9726C75.1061 66.1259 75.212 66.3284 75.2458 66.5484C75.2875 66.8095 75.2777 67.0762 75.217 67.3336C75.1485 67.6196 75.0307 67.8915 74.8689 68.137C74.7162 68.3638 74.5206 68.5586 74.2931 68.7102C74.1109 68.8212 73.9121 68.9025 73.7043 68.951C73.3848 69.0087 73.0604 69.0341 72.7359 69.0269H72.1732V69.0138V69.0059ZM72.4349 68.1894H72.6783C73.0601 68.2173 73.443 68.1545 73.7959 68.0062C73.9071 67.9354 74.0024 67.8424 74.0759 67.7329C74.1493 67.6235 74.1992 67.4999 74.2225 67.3702C74.2957 67.0535 74.2512 66.8101 74.0994 66.6897C73.9477 66.5693 73.5996 66.4934 73.0997 66.4934H72.8589L72.4349 68.1894Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M78.5015 71.7539L78.1979 70.1836H75.8424L74.7956 71.7539H73.7827L78.1717 65.415L79.5327 71.7539H78.5015ZM76.4078 69.3487H78.054L77.7923 67.9563C77.7753 67.856 77.7657 67.7545 77.7635 67.6527C77.75 67.5267 77.7448 67.4 77.7478 67.2732C77.6922 67.4041 77.6275 67.5309 77.5541 67.6527C77.4913 67.7731 77.4311 67.8804 77.3709 67.972L76.4182 69.3487H76.4078Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M80.904 71.754L81.5714 68.9693L80.3596 65.6716H81.3751L82.1315 67.7444C82.1472 67.8046 82.1602 67.8675 82.1917 67.9564C82.2231 68.0454 82.2388 68.1396 82.2676 68.2182L82.4481 67.9564C82.5083 67.8675 82.5711 67.7889 82.6313 67.713L84.4006 65.6716H85.3689L82.5397 68.9536L81.875 71.7383H80.904V71.754Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M90.119 68.7338C90.119 68.6893 90.1347 68.5506 90.1661 68.3386C90.1975 68.1266 90.1949 68.0219 90.2106 67.9016C90.1504 68.035 90.0902 68.1633 90.0143 68.3255C89.9367 68.4717 89.8492 68.6125 89.7526 68.7469L87.4207 72.0001L86.667 68.6893C86.6356 68.5506 86.6068 68.4276 86.5911 68.2941C86.5727 68.1684 86.5622 68.0417 86.5597 67.9146C86.5282 68.0377 86.4838 68.1764 86.4393 68.3255C86.3872 68.4749 86.3261 68.6208 86.2561 68.7626L84.8847 71.7541H83.9922L86.913 65.3995L87.7452 69.2416C87.7659 69.3418 87.7808 69.4432 87.7897 69.5452C87.8054 69.6812 87.8368 69.8618 87.8656 70.0686C87.9703 69.888 88.109 69.676 88.2896 69.4012C88.3305 69.3497 88.3664 69.2945 88.3969 69.2363L91.0298 65.3943L90.9487 71.7541H90.0562L90.1295 68.7286L90.119 68.7338Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M91.7261 71.7436L93.176 65.6455H96.4894L96.2957 66.4935H93.9481L93.5869 68.0219H95.9319L95.7199 68.883H93.3723L92.9038 70.8511H95.2514L95.0394 71.7436H91.7261Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M96.144 71.7539L97.6542 65.415L100.533 69.1367C100.609 69.244 100.685 69.3487 100.761 69.4691C100.837 69.5895 100.91 69.7308 101.002 69.8774L102.014 65.6558H102.909L101.394 71.9816L98.4603 68.184L98.2352 67.8673C98.1602 67.7536 98.0987 67.6315 98.052 67.5036L97.0391 71.7382H96.1467V71.7539H96.144Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M105.992 66.4776L104.739 71.7277H103.768L105.024 66.4776H103.451L103.647 65.6296H107.764L107.565 66.4776H105.992Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M107.005 70.5161L107.869 70.1549C107.866 70.271 107.888 70.3864 107.933 70.4934C107.978 70.6003 108.045 70.6964 108.131 70.7752C108.331 70.9256 108.577 71.0006 108.827 70.9872C109.096 70.9955 109.359 70.9093 109.57 70.7438C109.78 70.5838 109.925 70.3532 109.978 70.0947C110.067 69.7309 109.858 69.4116 109.343 69.142C109.29 69.1065 109.234 69.0758 109.175 69.0504C108.602 68.7181 108.238 68.4302 108.086 68.158C107.932 67.8591 107.9 67.5117 107.997 67.1896C108.108 66.7063 108.386 66.2779 108.782 65.9805C109.186 65.6704 109.682 65.5045 110.19 65.5094C110.557 65.4933 110.921 65.5842 111.237 65.7711C111.361 65.8547 111.464 65.9648 111.54 66.0933C111.616 66.2219 111.661 66.3658 111.674 66.5144L110.829 66.907C110.775 66.7407 110.674 66.5935 110.539 66.483C110.407 66.3896 110.249 66.3418 110.088 66.3469C109.849 66.3423 109.614 66.4168 109.421 66.5589C109.236 66.6954 109.107 66.8944 109.057 67.119C108.966 67.4827 109.222 67.8308 109.814 68.1475C109.847 68.1712 109.883 68.1914 109.921 68.2077C110.325 68.3844 110.675 68.6664 110.934 69.0243C111.09 69.334 111.122 69.6912 111.025 70.024C110.907 70.5695 110.601 71.0564 110.162 71.4007C109.716 71.7449 109.168 71.9293 108.604 71.9241C108.185 71.9503 107.77 71.8208 107.44 71.5603C107.29 71.4361 107.173 71.2772 107.099 71.0975C107.025 70.9179 106.995 70.7228 107.013 70.5292L107.005 70.5161Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M114.135 71.7436L115.587 65.6455H116.555L115.1 71.7436H114.135Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M116.493 71.7539L118.008 65.415L120.887 69.1367C120.963 69.244 121.039 69.3487 121.115 69.4691L121.358 69.8774L122.355 65.6454H123.248L121.732 71.9711L118.798 68.1736C118.723 68.0663 118.649 67.9616 118.571 67.8569C118.497 67.7431 118.436 67.621 118.39 67.4931L117.383 71.7277H116.493V71.7539Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M126.346 66.4776L125.09 71.7277H124.119L125.378 66.4776H123.802L123.999 65.6296H128.116L127.919 66.4776H126.346Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M127.388 71.7436L128.84 65.6455H132.172L131.973 66.4935H129.628L129.264 68.0219H131.612L131.397 68.883H129.055L128.587 70.8511H130.929L130.717 71.7436H127.388Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M133.366 69.0059L132.717 71.7277H131.806L133.261 65.6297H134.606C134.906 65.623 135.205 65.6493 135.499 65.7082C135.688 65.7443 135.861 65.8354 135.999 65.9699C136.152 66.1272 136.252 66.3286 136.284 66.5457C136.33 66.8065 136.32 67.0742 136.255 67.3309C136.169 67.7678 135.953 68.1684 135.635 68.4798C135.318 68.7604 134.922 68.9351 134.502 68.9797L135.878 71.7487H134.787L133.478 69.0268L133.366 69.0059ZM133.609 68.2338H133.79C134.148 68.2612 134.508 68.1991 134.837 68.0532C134.945 67.978 135.038 67.8814 135.108 67.7694C135.178 67.6573 135.225 67.5322 135.245 67.4015C135.323 67.0691 135.292 66.8257 135.143 66.6896C134.994 66.5535 134.672 66.4776 134.188 66.4776H134.007L133.609 68.2338Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M136.467 71.7436L137.919 65.6455H141.235L141.036 66.4935H138.691L138.328 68.0062H140.673L140.463 68.8673H138.116L137.438 71.7279H136.467V71.7436Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M144.457 71.7539L144.154 70.1836H141.798L140.752 71.7539H139.736L144.125 65.415L145.486 71.7539H144.457ZM142.364 69.3487H144.015L143.74 67.9563C143.723 67.856 143.714 67.7545 143.712 67.6527C143.698 67.5267 143.693 67.4 143.696 67.2732C143.58 67.5116 143.453 67.7447 143.316 67.972L142.364 69.3487Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M151.767 67.1293C151.563 66.8997 151.309 66.7205 151.024 66.6059C150.733 66.4814 150.419 66.4198 150.102 66.4253C149.465 66.421 148.847 66.6468 148.362 67.0613C147.848 67.4877 147.492 68.0735 147.349 68.7258C147.264 68.9969 147.238 69.2834 147.274 69.5654C147.31 69.8474 147.407 70.1182 147.559 70.3589C147.709 70.5715 147.912 70.7417 148.148 70.8531C148.384 70.9644 148.644 71.0133 148.904 70.9949C149.262 70.9966 149.617 70.93 149.951 70.7986C150.329 70.6576 150.686 70.4637 151.011 70.2228L150.749 71.343C150.45 71.5297 150.125 71.6683 149.783 71.7539C149.449 71.8459 149.104 71.8917 148.757 71.89C148.341 71.8981 147.928 71.8206 147.543 71.6623C147.201 71.5153 146.904 71.2806 146.682 70.9818C146.453 70.682 146.307 70.3273 146.258 69.9533C146.193 69.5295 146.219 69.0969 146.334 68.6839C146.439 68.2386 146.615 67.8134 146.857 67.4251C147.103 67.0315 147.416 66.6835 147.781 66.3965C148.131 66.1009 148.53 65.8705 148.961 65.716C149.373 65.566 149.808 65.4889 150.246 65.4883C150.575 65.4836 150.903 65.535 151.215 65.6401C151.509 65.7462 151.781 65.905 152.018 66.1086L151.757 67.1241L151.767 67.1293Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M151.856 71.7436L153.309 65.6455H156.625L156.428 66.4935H154.081L153.717 68.0219H156.065L155.85 68.883H153.505L153.037 70.8511H155.382L155.17 71.7436H151.856Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M134.243 60.3352H127.6L136.831 27H143.473L134.243 60.3352Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M130.793 28.0468C130.341 27.4082 129.63 27.0898 128.66 27.0916H92.1631L90.3625 33.6345H123.559L121.625 40.6094H95.0682V40.5937H88.4258L82.9297 60.4843H89.5617L93.2545 47.1366H123.106C124.067 47.1295 124.996 46.7933 125.739 46.184C126.524 45.5984 127.093 44.7705 127.359 43.8285L131.052 30.4808C131.337 29.4811 131.246 28.6802 130.79 28.0442L130.793 28.0468Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M79.0459 58.2466C78.8694 58.8912 78.4869 59.4604 77.9567 59.8672C77.4265 60.2741 76.7777 60.4963 76.1094 60.5H41.8661C40.9265 60.5 40.233 60.1807 39.7723 59.5447C39.3117 58.9088 39.2096 58.1236 39.4844 57.1893L47.8437 27.0916H54.4862L47.0272 53.957H73.5969L81.0559 27.0916H87.701L79.0459 58.2361V58.2466Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M154.944 27.0603L163.34 43.7658L145.682 60.4714L154.944 27.0603Z"
                                            fill="currentColor" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M149.043 27.0603L157.439 43.7658L139.765 60.4714L149.043 27.0603Z"
                                            fill="currentColor" />
                                    </svg>
                                </div>
                                <div class="payment-methods__list-item">
                                    <svg width="200" height="100" viewBox="0 0 200 100" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M54.188 49.3139C58.6418 50.4335 62.3775 44.6785 62.3775 44.6785C66.0596 50.4283 69.0392 45.798 69.0392 45.798C69.0392 45.798 66.2915 50.4335 57.5413 50.25L54.188 49.3139Z"
                                            fill="currentColor" />
                                        <path
                                            d="M71.3924 39.7695C71.3924 39.7695 65.0405 52.8575 54.124 49.3917C54.124 49.3917 74.0519 55.5343 81.3538 44.5746L71.3924 39.7695Z"
                                            fill="currentColor" />
                                        <path
                                            d="M77.639 48.9869V66.963H57.2578L57.2578 50.75C56.7335 50.6271 56.2801 50.4749 55.9548 50.3538L55.9548 69.1605C55.9548 71.005 57.237 72.5 58.8202 72.5H76.0783C77.6598 72.5 78.9419 71.005 78.9419 69.1605V48.0889C78.5145 48.4072 78.0127 48.7447 77.639 48.9869Z"
                                            fill="currentColor" />
                                        <path
                                            d="M57.2561 31.1371H77.6391V41.9948L78.942 42.7474V30.8378C78.942 28.9933 77.6598 27.5 76.0783 27.5H58.8185C57.2371 27.5 55.9549 28.9933 55.9549 30.8378L55.9548 48.827C56.5362 48.7457 56.9774 48.6073 57.2578 48.5L57.2578 31.1371H57.2561Z"
                                            fill="currentColor" />
                                        <path
                                            d="M52.4716 46.8622V59.9225H44.4672V48.1685C44.4672 44.8827 43.1193 43.4915 41.0118 43.4915C38.6949 43.4915 37.0096 45.0505 37.0096 48.589V59.9225H29.0052V48.1685C29.0052 44.8827 27.6989 43.4915 25.5498 43.4915C23.1914 43.4915 21.5061 45.0505 21.5061 48.589V59.9225H13.5V37.0877H21.1272V39.4893C22.854 37.6362 25.2557 36.7087 27.9532 36.7087C31.0695 36.7087 33.7238 37.8455 35.326 40.2905C37.1377 38.0151 39.9598 36.7087 43.2474 36.7087C48.5559 36.7087 52.4733 39.7835 52.4733 46.8622"
                                            fill="currentColor" />
                                        <path
                                            d="M108.722 48.5042C108.722 55.7525 103.709 60.3015 97.5149 60.3015C94.8623 60.3015 92.7133 59.5003 91.1526 57.8998V68.0947H83.1482V37.0877H90.7736V39.3613C92.2911 37.5514 94.5232 36.707 97.5149 36.707C103.709 36.707 108.722 41.256 108.722 48.5042ZM100.633 48.5042C100.633 45.0506 98.5271 43.0694 95.8296 43.0694C93.132 43.0694 91.0263 45.0506 91.0263 48.5042C91.0263 51.9579 93.1338 53.9391 95.8296 53.9391C98.5254 53.9391 100.633 51.9597 100.633 48.5042Z"
                                            fill="currentColor" />
                                        <path
                                            d="M135.642 50.5287H119.043C119.718 52.8438 121.697 54.1935 124.648 54.1935C126.88 54.1935 128.354 53.5619 129.915 52.2123L134.128 56.5934C131.937 59.0383 128.735 60.3014 124.397 60.3014C116.264 60.3014 110.999 55.2888 110.999 48.461C110.999 41.6332 116.349 36.707 123.554 36.707C130.295 36.707 135.772 41.0034 135.772 48.5458C135.772 49.1358 135.689 49.8954 135.645 50.527M118.917 46.3137H128.271C127.849 43.912 126.08 42.3963 123.594 42.3963C121.107 42.3963 119.381 43.9103 118.917 46.3137Z"
                                            fill="currentColor" />
                                        <path
                                            d="M137.665 57.943L140.066 52.4666C142.174 53.7713 145.249 54.5724 148.029 54.5724C150.81 54.5724 151.609 53.9824 151.609 53.0134C151.609 49.9369 138.127 53.4339 138.127 44.2909C138.127 39.9929 142.087 36.7087 149.251 36.7087C152.452 36.7087 155.992 37.3818 158.266 38.6467L155.864 44.0798C153.589 42.8167 151.313 42.3962 149.291 42.3962C146.595 42.3962 145.626 43.1541 145.626 43.9968C145.626 47.158 159.067 43.7442 159.067 52.8023C159.067 57.0173 155.191 60.3014 147.775 60.3014C143.899 60.3014 139.897 59.3325 137.663 57.9413"
                                            fill="currentColor" />
                                        <path
                                            d="M186.663 37.0877V59.9225H179.038V57.6472C177.522 59.4588 175.288 60.3014 172.297 60.3014C166.104 60.3014 161.091 55.7507 161.091 48.461C161.091 41.1712 166.104 36.707 172.297 36.707C174.951 36.707 177.1 37.4666 178.659 39.0654V37.086H186.663V37.0877ZM178.785 48.4627C178.785 45.0073 176.68 43.0694 173.984 43.0694C171.288 43.0694 169.18 45.0073 169.18 48.4627C169.18 51.9181 171.286 53.9391 173.984 53.9391C176.681 53.9391 178.785 51.9597 178.785 48.4627Z"
                                            fill="currentColor" />
                                    </svg>
                                </div>
                                <div class="payment-methods__list-item">
            ...
            <section class="section risk-disclosure">
                <div class="container">
                    <div class="content risk-disclosure__in">
                        ...
                        <p>Trading on financial markets carries risks. Contracts for Difference (‘CFDs’) are complex
                            financial products that are traded on margin. Trading CFDs carries a high level of risk
                            since leverage can work both to your advantage and disadvantage. As a result, CFDs may not
                            be suitable for all investors because you may lose all your invested capital. You should not
                            risk more than you are prepared to lose. Before deciding to trade, you need to ensure that
                            you understand the risks involved and taking into account your investment objectives and
                            level of experience.</p>
                        <p class="risk-disclosure__link-title">
                            <a href="https://m.pocketoption.com/en/riskdisclosure/" target="_blank"
            ...
            <div class="container">
                <div class="content footer__in">
                    <div class="footer__info">
                        <p class="no-margin">
                            All materials and services provided on this site are subject to copyright and belong to
                            "Infinite Trade LLC". Any use of materials of this website must be approved by an official
                            representative of "Infinite Trade LLC", and contain a link to the original resource. Any
                            third-party companies of "Online broker" or "Online trading" type, do not have the right to
                            use materials of this website as well as any distorted writing of "Infinite Trade LLC". In
                            case of violation, they will be prosecuted in accordance with legislation of intellectual
                            property protection. </p>

                        <p class="no-margin">
                            Infinite Trade LLC does not provide service to residents of the EEA countries, USA, Israel,
                            UK and Japan. </p>

                        <p>
                            Infinite Trade LLC is registered at Republic Of Costa Rica, San Jose- San Jose Mata Redonda,
                            Neighborhood Las Vegas, Blue Building Diagonal To La Salle High School with the registration
                            number 4062001303240.
                            <br>
                    ...
                    <div class="socket">
                        <a href="https://m.pocketoption.com/en/" class="socket__logo logo">
                            <svg width="224" height="33" viewBox="0 0 224 33" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="socket__copyright">
                            <div class="plus-21">
                                <p>
                                    Copyright &copy;2024 Pocket Option <br>PO TRADE LTD is the owner of the
                                    pocketoption.com domain. </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sidebar__container">
                        ...
                        <div class="login login-v2">
                            <div class="sidebar__register">
                                ...
                                <form action="{{route('register')}}" method="post" class="form-with-label">
                                    <input type="hidden" name="submitLogin" value="1">
                                    <div class="form-group">
                                        <input type="email" name="email" value="" class="form-control" required="1"
                                            autocomplete="off" placeholder="Email" id="register_email" /> <label
                                            for="register_email">Email</label>
                                    </div>
                                    <div class="form-group  password-container">
                                        <input type="password" name="password" value="" id="register_password"
                                            class="form-control js-f-pswd-input" required="1" autocomplete="off"
                                            placeholder="Password" /> <label for="register_password">Password</label>
                                    </div>
                                    <div class="form-group ">
                                        <input type="text" name="promo_code" value="" id="register_promo_code"
                                            class="form-control" autocomplete="off" placeholder="Promo code" /> <label
                                            for="register_promo_code">Promo code</label>
                                    </div>
                                    ...
                                    <div class="form-group js-recaptcha-block recaptcha-block hidden">
                                        <div class="js-recaptcha-widget g-recaptcha" data-name="sidebar-register"
                    ...
                    <div class="sidebar__container">
                        ...
                        <div class="login login-v2">
                            <div class="sidebar__login">
                                ...
                                <form action="{{route('login')}}" method="POST" class="form-with-label">
                                    <input type="hidden" name="submitLogin" value="1">
                                    <div class="step1 js-step1">
                                        <div class="form-group">
                                            <input type="email" name="email" value="" class="form-control" required="1"
                                                placeholder="Email" id="login_email" /> <label
                                                for="login_email">Email</label>
                                        </div>
                                        <div class="form-group   password-container">
                                            <input type="password" name="password" value=""
                                                class="form-control js-f-pswd-input" required="1" autocomplete="off"
                                                placeholder="Password" id="login_password" /> <label
                                                for="login_password">Password</label>
                                        </div>
                                        <div class="checkbox">
                                            <div class="checkbox checkbox_small clearfix m-b-0 ">
                                                <label>
                                                    <input type="checkbox" name="remember" value="1" />Remember me <span
                                                        class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group js-recaptcha-block recaptcha-block hidden">
                                            <div class="js-recaptcha-widget g-recaptcha" data-name="sidebar-login"
                                                data-callback="verifyCallback"></div>
                                            <script>
                                                function verifyCallback() {
